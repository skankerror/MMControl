  ...
  m_iswaiting(true)
{
  switch(m_champ)
  {
  case P_OPACITY: m_p_ID1 = ID1; m_p_opacity = var; m_iswaiting = true; break;
  case P_VOLUME: m_p_ID1 = ID1; m_p_volume = var; m_iswaiting = true; break;
  case P_RATE: m_p_ID1 = ID1; m_p_rate = var; m_iswaiting = true; break;
  case M_OPACITY: m_m_ID1 = ID1; m_m_opacity = var; m_iswaiting = true; break;
  case M_DEPTH: m_m_ID1 = ID1; m_m_depth = var; m_iswaiting = true; break;
  case P_XFADE: m_p_ID1 = ID1; m_p_ID2 = var; m_iswaiting = true; break;
  ...
  m_iswaiting(true)
{
  switch (m_champ)
  {
  case M_VISIBLE: m_m_ID1 = ID1; m_m_isvisible = isproperty; m_iswaiting = true; break;
  case M_SOLO: m_m_ID1 = ID1; m_m_issolo = isproperty; m_iswaiting = true; break;
  case M_LOCK: m_m_ID1 = ID1; m_m_islocked = isproperty; m_iswaiting = true; break;
  case P_FADE: m_p_ID1 = ID1; m_isfadein = isproperty; m_iswaiting = true; break;
